      ...
      <Table striped bordered hover style={{ border: "2px solid black" }}>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Jl. Kepatihan No.11-17, Balonggede, Kec. Regol, Kota Bandung
            </td>
            <td>Atlet Volly</td>
            <td>A</td>
          ...
          <tr>
            ...
            <td>
              Jl. Bojong Koneng Atas No.63, Mekarsaluyu, Kecamatan Bojong
              Koneng, Kota Bandung
            </td>
            <td>Youtuber</td>
            <td>AB+</td>
          ...
          <tr>
            ...
            <td>
              Jl. Muararajeun No.12, Muararajeun, Kecamatan Cihapit, Kota
              Bandung
            </td>
            <td>Programmer</td>
            <td>O</td>
          ...
          <tr>
            ...
            <td>
              Jl. Luna No.26, Cibadak, Kecamatan Pasir Kaliki, Kota Bandung
            </td>
