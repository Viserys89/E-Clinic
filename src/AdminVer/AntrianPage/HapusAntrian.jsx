...
const HapusAntrian = () => {
  ...
  const namaPoliklinik = "Penyakit Dalam";
  ...
  return (
    <div id="hapusAntrianPage">
        ...
        <div className="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li className="breadcrumb-item text-sm">
                <Link className="opacity-5 text-dark" to="/PoliklinikAntrian">
                  Poliklinik
                </Link>
              </li>
              <li
      ...
      <div className="container-fluid">
        <h2 id="titledashboard">Antrian {namaPoliklinik}</h2>
        <div className="container-lg mt-3">
          ...
          <div className="card mt-3">
            <div className="card-body text-center">
              <h4>
                <b>
                  Tabel diatas ini berfungsi untuk menhapus seseorang dari
                  antrian, jika orang tersebut tidak datang pada bata waktu yang
                  telah disediakan
                </b>
              </h4>
            </div>
